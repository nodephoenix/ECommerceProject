...
const development = {
  ...
  password: process.env.SEQUELIZE_DEVELOPMENT_PASSWORD || "ghkswns139",
...
const test = {
  ...
  password: process.env.SEQUELIZE_TEST_PASSWORD || "ghkswns139",
...
const production = {
  ...
  password: process.env.SEQUELIZE_PRODUCTION_PASSWORD || "ghkswns139",
